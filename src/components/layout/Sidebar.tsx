      ...
      <div className="px-3 mb-4">
        <div className="flex items-center gap-2.5 group cursor-pointer border-b border-border pb-4">
          ...
          <div className="flex flex-col">
            <h1 className="text-base font-black italic tracking-tighter uppercase leading-none">
              <span className="text-text-1">RDY</span><span className="text-primary ml-1">SUPPLY</span>
            </h1>
            <p className="text-[7px] font-bold text-text-2 uppercase tracking-[0.25em] opacity-40 leading-none mt-1.5">INVESTIMENTO - PERFORMANCE</p>
          </div>
        </div>
      </div>
